      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div className="md:col-span-2">
            ...
            <p className="text-zaz-dark-gray mb-6 max-w-md">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#diferencias" className="text-zaz-dark-gray hover:text-zaz-blue transition-colors">
                  Qué nos Diferencia
                </a>
              </li>
              <li>
                <a href="#soluciones" className="text-zaz-dark-gray hover:text-zaz-blue transition-colors">
                  Soluciones
                </a>
              </li>
              <li>
                <a href="#nosotros" className="text-zaz-dark-gray hover:text-zaz-blue transition-colors">
                  Nosotros
                </a>
              </li>
              <li>
                <a href="#" className="text-zaz-dark-gray hover:text-zaz-blue transition-colors flex items-center">
                  Blog <ExternalLink className="w-3 h-3 ml-1" />
                </a>
              </li>
              <li>
                <a href="#" className="text-zaz-dark-gray hover:text-zaz-blue transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <MapPin className="w-5 h-5 text-zaz-blue mr-2 mt-0.5" />
                <span className="text-zaz-dark-gray">
                  Av. Reforma 222, Ciudad de México, CDMX
                </span>
              </li>
              <li className="flex items-center">
                <Mail className="w-5 h-5 text-zaz-blue mr-2" />
                <a href="mailto:info@zazsoluciones.com" className="text-zaz-dark-gray hover:text-zaz-blue transition-colors">
                  info@zazsoluciones.com
                </a>
              </li>
              <li className="flex items-center">
                <Phone className="w-5 h-5 text-zaz-blue mr-2" />
                <a href="tel:+525512345678" className="text-zaz-dark-gray hover:text-zaz-blue transition-colors">
                  +52 55 1234 5678
                </a>
              </li>
            </ul>
